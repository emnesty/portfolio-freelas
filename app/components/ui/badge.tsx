...
const colors = {
  ...
  zinc: "bg-zinc-600/10 text-zinc-700 group-data-[hover]:bg-zinc-600/20 dark:bg-white/5 dark:text-zinc-400 dark:group-data-[hover]:bg-white/10 border border-zinc-100 border-zinc-700",
};
...
export function Badge({
  ...
  return (
    <span
      ...
      className={clsx(
        className,
        "inline-flex items-center gap-x-1.5 rounded-lg px-2.5 py-1.5 text-sm/5 font-medium sm:text-xs/5 forced-colors:outline",
        colors[color]
      )}
    />
  );
