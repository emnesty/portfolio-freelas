              ...
              <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
                ...
                <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                  <figure className="relative isolate pt-6 sm:pt-12">
                    ...
                    <div className="flex gap-5 pr-20 mt-6 max-md:flex-wrap max-md:pr-5">
                      <p className="justify-center mb-6 text-xl text-stone-300">
                        Olá, me chamo Luciano
                      </p>
                    </div>
                    <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                      <p>
                        Hoje atuando como UX/UI Designer, com mais de 10 anos de
                        experiência, adquiri vasta experiência no mercado e
